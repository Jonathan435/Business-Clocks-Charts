...
* ```LowPerFormanceColor```: Gets or sets the graphical low performance area in the clock with the color that was selected (binded to ```LowPerformance``` property).<br/>
