...
* ```HighPerformance```: Gets or sets the indication for High performance, this property is binded to **HighPerFormanceColor** property and its value will set the graphical area of the High performance clock with **HighPerFormanceColor** color.<br/><br/>
